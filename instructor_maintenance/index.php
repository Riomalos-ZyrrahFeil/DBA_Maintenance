...
<head>
  ...
  <title>Instructor Maintenance - PUP</title>
    ...
    <main class="main-content">
      <div class="container">
        <header class="content-header">
          <h1>Instructor Maintenance</h1>
          <button id="addBtn" class="primary-btn">+ Add New Instructor</button>
        </header>

        <div class="table-header">
          <div class="search-container">
            <input type="text" id="search" placeholder="Search instructors...">
          </div>
        ...
        <div class="table-container card">
          <table id="instructorTable">
            <thead>
              <tr>
                <th data-column="instructor_id">Instructor ID ↕</th>
        ...
        <div id="formModal" class="modal">
          <div class="modal-content card">
            ...
            <div class="form-buttons">
              <button id="saveBtn">Save Instructor</button>
